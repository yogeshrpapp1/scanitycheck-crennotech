      ...
      try {
        ...
        const chart = scanList
          ...
          .map(s => {
            ...
            const extract = (label) => {
              const match = summary.match(new RegExp(`${label}: (\\d+)`));
        ...
        if (scanList.length > 0) {
          ...
          const extract = (label) => {
            const match = s.match(new RegExp(`${label}: (\\d+)`));
            return match ? parseInt(match[1]) : 0;
          };
          setSeverityCounts({
            critical: extract("Critical"),
      ...
      >
        ...
        >
          ...
          >
            ...
            <p style={{ color: "red", fontSize: "28px", fontWeight: "700" }}>{severityCounts.critical}</p>
          </div>
          ...
          >
            ...
            <p style={{ color: "orange", fontSize: "28px", fontWeight: "700" }}>{severityCounts.high}</p>
          </div>
          ...
          >
            ...
            <p style={{ color: "blue", fontSize: "28px", fontWeight: "700" }}>{severityCounts.medium}</p>
          </div>
          ...
          >
            ...
            <p style={{ color: "green", fontSize: "28px", fontWeight: "700" }}>{severityCounts.low}</p>
          </div>
        </div>
