...
const [selectedSeverity, setSelectedSeverity] = useState("All");
  ...
  const fetchReportData = async () => {
    ...
    setSummary({
      critical: summaryData.critical || summaryData.Critical || 0,
      high: summaryData.high || summaryData.High || 0,
      medium: summaryData.medium || summaryData.Medium || 0,
      low: summaryData.low || summaryData.Low || 0,
    });
  };
